...
function Sprint() {
    ...
    const wordsEng = wordsEasy.map((el) => el.en);
    const wordsRu = wordsEasy.map((el) => el.ru);
                    ...
                    <div className="sprint__bg">
                        ...
                        <div className="sprint__game-card">
                            ...
                            <div className="answer__result">
                                <img alt="ok" src={okImg} className="ok__img" id="ok__img"/>
                                <img alt="error" src={errorImg} className="error__img" id="error__img"/>
                            </div>
